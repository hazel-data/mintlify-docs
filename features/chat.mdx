...
keywords: ["chat", "ask questions", "plain English", "data analysis", "file upload", "web search"]
icon: "message-circle"
---
...
**Next up:** Learn the difference between [Ask and Deep Thinking](/features/ask-vs-deep-thinking) so you can pick the right mode for your question.
