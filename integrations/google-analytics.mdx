...
<Steps>
  ...
  <Step title="Find Google Analytics and click Connect">
    Search for Google Analytics or find it in the Marketing category.
  </Step>

  <Step title="Sign in with your Google account">
    You'll be redirected to Google to authorize the connection. Use the account that has access to your GA4 property.
  </Step>
</Steps>
